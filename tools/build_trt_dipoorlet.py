...
def main():
    onnx_file = "../../dipoorlet_work_dir/yolov8n_brecq_mse/brecq.onnx"
    engine_file = "../../trt/yolov8n_dipoorlet_brecq_int8.engine"
    json_path = "../../dipoorlet_work_dir/yolov8n_brecq_mse/trt_clip_val.json"
